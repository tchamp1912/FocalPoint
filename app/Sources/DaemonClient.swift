...
private final class AppLog: @unchecked Sendable {
    ...
    func write(_ message: String) {
        ...
        // Finder normally supplies /dev/null, but a CLI launch may inherit a
        // pipe whose reader exits. Logging must never terminate the app.
        _ = focalpointWriteSafely(Data(line.utf8), to: FileHandle.standardError)
    }
